...
package Bio::KBase::SSHAgent::Buffer;
use strict;

{
    my %MP_MAP = (
        SSH1 => [ "use Math::GMP;", \&_get_mp_int_ssh1, \&_put_mp_int_ssh1 ],
        SSH2 => [ "use Bio::KBase::SSHAgent::Util qw( :ssh2mp )",
...
Bio::KBase::SSHAgent::Buffer - Low-level read/write buffer class

=head1 SYNOPSIS

    use Bio::KBase::SSHAgent::Buffer (@args);
    my $buffer = Bio::KBase::SSHAgent::Buffer->new;
...
I<Bio::KBase::SSHAgent::Buffer> implements the low-level binary
buffer needed by the I<Bio::KBase::SSHAgent> suite. Specifically,
a I<Bio::KBase::SSHAgent::Buffer> object is what makes up the
data segment of a packet transferred between server and
client (a I<Bio::KBase::SSHAgent::Packet> object).
...
most users/developers of I<Bio::KBase::SSHAgent> need to care
...
the proper I<get> and I<put> routines for bigints:
    ...
    use Bio::KBase::SSHAgent::Buffer qw( SSH1 );
...
=head2 Bio::KBase::SSHAgent::Buffer->new
