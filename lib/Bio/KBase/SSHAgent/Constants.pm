...
package Bio::KBase::SSHAgent::Constants;
use strict;
...
Bio::KBase::SSHAgent::Constants - Exportable constants

=head1 SYNOPSIS

    use Bio::KBase::SSHAgent::Constants qw( constants );

=head1 DESCRIPTION

I<Bio::KBase::SSHAgent::Constants> provides a list of common and
...
look something like this:
    ...
    use Bio::KBase::SSHAgent::Constants qw( :group );
...
See the I<Bio::KBase::SSHAgent::Packet> and I<Bio::KBase::SSHAgent> docs
for details.

I<Bio::KBase::SSHAgent> doesn't support all of the features of
...
Here's the list of MSG constants supported by I<Bio::KBase::SSHAgent>:
...
routine in I<Bio::KBase::SSHAgent::Util>. See those docs for
...
supported by this SSH client (ie., I<Bio::KBase::SSHAgent>).
